...
/**
 * <p>
 * Java class for DT_WebDAV complex type.
 * 
 * <p>
...
@XmlType(name = "DT_WebDAV", propOrder = { "webDAV" })
public class DTWebDAV {

	@XmlElement(name = "WebDAV", required = true)
	protected List<DTWebDAV.WebDAV> webDAV;
	 ...
	 * {@link DTWebDAV.WebDAV }
	 * 
	 * 
	 */
	public List<DTWebDAV.WebDAV> getWebDAV() {
		if (webDAV == null) {
			webDAV = new ArrayList<DTWebDAV.WebDAV>();
		}
		return this.webDAV;
	}
